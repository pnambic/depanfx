...
import com.pnambic.depanfx.nodefilters.gui.DepanFxNodeFiltersDataProvider;
import com.pnambic.depanfx.nodefilters.gui.DepanFxNodeFiltersDialogRegistry;
import com.pnambic.depanfx.nodefilters.gui.DepanFxNodeFiltersDisplayMember;
...
@DepanFxFxmlDialog
@FxmlView("filter-selection-dialog.fxml")
public class DepanFxFilterSelectionDialog extends DepanFxWorkspaceDialog {

  private static final Logger LOG =
      LoggerFactory.getLogger(DepanFxFilterSelectionDialog.class);
  ...
  @Autowired
  public DepanFxFilterSelectionDialog(
  ...
  public static Stage runEditDialog(
    ...
    Dialog<DepanFxFilterSelectionDialog> dlg =
        dialogRunner.createDialogAndParent(
            DepanFxFilterSelectionDialog.class);

    DepanFxFilterSelectionDialog dlgState = dlg.getController();
