...
public class DepanFxNodeFiltersNodeKindMember
    extends DepanFxNodeFiltersDisplayMember<DepanFxNodeKindFilterData> {

  private final BooleanProperty useInverseProperty;

  public DepanFxNodeFiltersNodeKindMember(
      DepanFxNodeFiltersTableMember parentMember,
      DepanFxNodeKindFilterData kindFilter) {
    super(parentMember, kindFilter);
    useInverseProperty =
        new SimpleBooleanProperty(kindFilter.isExclusionFilter());
  }
  ...
  public DepanFxBaseFilterData prepareFilterData() {
    return new DepanFxNodeKindFilterData(
        ...
        getMergeModeProperty().get(), getFilterData().getNodeKind(),
