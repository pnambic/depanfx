...
@Component
public class ListFilterPersistenceContribution
    implements DocumentPersistenceContribution {

  public static final String EXTENSION =
      DepanFxListFilterData.LIST_FILTER_TOOL_EXT;

  public static final String LIST_FILTER_INFO_TAG = "list-filter-info";
  ...
  @Autowired
  public ListFilterPersistenceContribution(
  ...
  public boolean acceptsDocument(Object document) {
    return DepanFxListFilterData.class.isAssignableFrom(document.getClass());
  }
  ...
  public void prepareTransport(PersistDocumentTransportBuilder builder) {
    builder.addAlias(LIST_FILTER_INFO_TAG, DepanFxListFilterData.class);
