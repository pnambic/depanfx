...
@Component
public class NodeFilterSequencePersistenceContribution
    implements DocumentPersistenceContribution {

  public static final String EXTENSION =
      DepanFxNodeFilterSequenceData.NODE_FILTER_SEQUENCE_TOOL_EXT;

  public static final String NODE_FILTER_SEQUENCE_TAG = "filter-seq";
  ...
  @Autowired
  public NodeFilterSequencePersistenceContribution(
  ...
  public boolean acceptsDocument(Object document) {
    return DepanFxNodeFilterSequenceData.class
