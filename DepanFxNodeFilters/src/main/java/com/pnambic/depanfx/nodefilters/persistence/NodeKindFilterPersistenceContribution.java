...
@Component
public class NodeKindFilterPersistenceContribution
    implements DocumentPersistenceContribution {

  public static final String EXTENSION =
      DepanFxNodeKindFilterData.NODE_KIND_FILTER_TOOL_EXT;

  public static final String NODE_KIND_FILTER_INFO_TAG =
      "node-kind-filter-info";
  ...
  @Autowired
  public NodeKindFilterPersistenceContribution() {
  }
  ...
  public void prepareTransport(PersistDocumentTransportBuilder builder) {
    ContextNodeKindIdConverter.installIn(builder);

    builder.addAlias(NODE_KIND_FILTER_INFO_TAG,
        DepanFxNodeKindFilterData.class);
