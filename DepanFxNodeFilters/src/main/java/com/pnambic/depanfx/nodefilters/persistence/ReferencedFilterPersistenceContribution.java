...
@Component
public class ReferencedFilterPersistenceContribution
    implements DocumentPersistenceContribution {

  public static final String EXTENSION =
      DepanFxReferencedFilterData.REFERENCED_FILTER_TOOL_EXT;

  public static final String REFERENCED_FILTER_INFO_TAG =
      "referenced-filter-info";
  ...
  @Autowired
  public ReferencedFilterPersistenceContribution(
  ...
  public boolean acceptsDocument(Object document) {
    return DepanFxReferencedFilterData.class.isAssignableFrom(
        document.getClass());
  }
  ...
  public void prepareTransport(PersistDocumentTransportBuilder builder) {
    builder.addAlias(
        REFERENCED_FILTER_INFO_TAG, DepanFxReferencedFilterData.class);
