...
public class DepanFxListFilter
    extends DepanFxBaseFilter<DepanFxListFilterData> {

  public DepanFxListFilter(
  ...
  protected Collection<GraphNode> computeResult(Collection<GraphNode> nodes) {
    return getFilterData().getNodeListResource().getResource().getNodes();
  }
}
