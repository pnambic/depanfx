...
@Component
public class DepanFxNewGitContribution
    implements DepanFxNewResourceContribution {

  private final DepanFxDialogRunner dialogRunner;

  public DepanFxNewGitContribution(DepanFxDialogRunner dialogRunner) {
  ...
  private void runDialog() {
    dialogRunner.runDialog(
        DepanFxNewGitRepoDialog.class, "Create new graph from git");
  }
}
